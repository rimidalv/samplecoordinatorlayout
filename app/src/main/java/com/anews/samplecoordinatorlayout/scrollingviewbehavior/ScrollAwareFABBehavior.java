...
public class ScrollAwareFABBehavior extends FloatingActionButton.Behavior {
    ...
    public boolean onStartNestedScroll(final CoordinatorLayout coordinatorLayout, final FloatingActionButton child,
        ...
        L.d("onStartNestedScroll: directTargetChild = " + directTargetChild + " target = " + target.getClass().getSimpleName());
    ...
    public void onNestedScroll(final CoordinatorLayout coordinatorLayout, final FloatingActionButton child,
        ...
        L.d("onNestedScroll: target = " + target.getClass().getSimpleName() + " dyConsumed = " + dyConsumed + " dyUnconsumed = " + dyUnconsumed + " ");

    }

    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
//        L.d("layoutDependsOn: dependency = " + dependency.getClass().getSimpleName());
        return dependency instanceof NestedScrollView;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
        L.d("onDependentViewChanged: dependency = " + dependency.getClass().getSimpleName());
        return super.onDependentViewChanged(parent, child, dependency);
    }

    @Override
    public void onDependentViewRemoved(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
        L.d("onDependentViewRemoved: dependency = " + dependency.getClass().getSimpleName());
        super.onDependentViewRemoved(parent, child, dependency);
    }

    @Override
    public boolean onLayoutChild(CoordinatorLayout parent, FloatingActionButton child, int layoutDirection) {
        L.d("onLayoutChild: layoutDirection = " + layoutDirection);
...
//    }
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, FloatingActionButton child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        L.d("onMeasureChild: widthUsed = " + widthUsed + " heightUsed = " + heightUsed);
    ...
    public void onNestedScrollAccepted(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View directTargetChild, View target, int nestedScrollAxes) {
        L.d("onNestedScrollAccepted: directTargetChild = " + directTargetChild.getClass().getSimpleName() + " target = " + target.getClass().getSimpleName());
        super.onNestedScrollAccepted(coordinatorLayout, child, directTargetChild, target, nestedScrollAxes);
    }

    @Override
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View target) {
        L.d("onStopNestedScroll: target = " + target.getClass().getSimpleName());
        super.onStopNestedScroll(coordinatorLayout, child, target);
    }

    @Override
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View target, int dx, int dy, int[] consumed) {
        L.d("onNestedPreScroll: target = " + target.getClass().getSimpleName() + " dx = "+dx + " dy = "+ dy + " consumed = "+ (consumed != null && consumed.length > 1 ? consumed[1] : null));
    ...
    public boolean onNestedFling(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View target, float velocityX, float velocityY, boolean consumed) {
        L.d("onNestedFling: target = " + target.getClass().getSimpleName() + " velocityX = " + velocityX + " velocityY = " + velocityY);
    ...
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View target, float velocityX, float velocityY) {
        L.d("onNestedPreFling: target = " + target.getClass().getSimpleName() + " velocityX = "+velocityX + " velocityY = "+ velocityY);
